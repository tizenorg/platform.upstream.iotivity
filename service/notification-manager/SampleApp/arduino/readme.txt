...
1. Applications on arduino conform  the Iotivity Base released on 22-Aug-2014.
   ...
   For successful execution, you have to copy the file, local.properties, into the following paths:
    - oic-resource/csdk/
    - oic-resource/csdk/libcoap-4.1.1


2. Time.c, Time.h should be copied in your machine and they should be referred in the Makefile as followings
